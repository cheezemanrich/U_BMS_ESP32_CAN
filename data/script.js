...
if (!!window.EventSource) {
  ...
  source.addEventListener('new_readings', function(e) {
	...
	uppercurrent = (Number(obj.batt2data13) + Number(obj.batt4data13) + Number(obj.batt6data13) + Number(obj.batt8data13));	// total of 4 upper batt currents
	lowercurrent = (Number(obj.batt1data13) + Number(obj.batt3data13) + Number(obj.batt5data13) + Number(obj.batt7data13));	// total of 4 lower batt currents
	totalcurrent = (uppercurrent + lowercurrent) /2;	// average of upper and lower current
	uppervoltage = ((Number(obj.batt2data5) + Number(obj.batt4data5) + Number(obj.batt6data5) + Number(obj.batt8data5)) / 4);	// average of 4 upper batt voltages
	lowervoltage = ((Number(obj.batt1data5) + Number(obj.batt3data5) + Number(obj.batt5data5) + Number(obj.batt7data5)) / 4);	// average of 4 lower batt voltages
	totalvoltage = uppervoltage + lowervoltage; // total of upper and lower voltages (system voltage)
		// average of SOC readings
	totalsocupper = (Number(obj.batt2data15) + Number(obj.batt4data15) + Number(obj.batt6data15) + Number(obj.batt8data15)) / 4;
	totalsoclower = (Number(obj.batt1data15) + Number(obj.batt3data15) + Number(obj.batt5data15) + Number(obj.batt7data15)) / 4;
	...
	if(Number(obj.batt1data11 == 0) && Number(obj.batt2data11 == 0) && Number(obj.batt3data11 == 0) && Number(obj.batt4data11 == 0) && Number(obj.batt1data12 == 0) && Number(obj.batt2data12 == 0) && Number(obj.batt3data12 == 0) && Number(obj.batt4data12 == 0) && Number(obj.batt5data11 == 0) && Number(obj.batt6data11 == 0) && Number(obj.batt7data11 == 0) && Number(obj.batt8data11 == 0) && Number(obj.batt5data12 == 0) && Number(obj.batt6data12 == 0) && Number(obj.batt7data12 == 0) && Number(obj.batt8data12 == 0)) {document.getElementById("systemcolor").innerHTML = "<h3 style=\"background-color:MediumSeaGreen;\"><b>System</b></h3>"} 
	else {document.getElementById("systemcolor").innerHTML = "<h3 style=\"background-color:Tomato;\"><b>System</b></h3>"};
	
	document.getElementById("systemsocupper").innerHTML = (totalsocupper).toFixed(1);
	document.getElementById("systemsoclower").innerHTML = (totalsoclower).toFixed(1);
	document.getElementById("systemsoc").innerHTML = totalsoc.toFixed(1);
	...
	document.getElementById("systemcurrent").innerHTML = totalcurrent.toFixed(1);
	document.getElementById("systemcurrupper").innerHTML = uppercurrent.toFixed(1);
	document.getElementById("systemcurrlower").innerHTML = lowercurrent.toFixed(1);
	document.getElementById("systempower").innerHTML = ((totalvoltage / 1000) * totalcurrent).toFixed(0); // change to V, change to A
	...
	document.getElementById("batt1data13").innerHTML = (Number(obj.batt1data13)).toFixed(1);	// Get currents
	document.getElementById("batt2data13").innerHTML = (Number(obj.batt2data13)).toFixed(1);
	document.getElementById("batt3data13").innerHTML = (Number(obj.batt3data13)).toFixed(1);
	document.getElementById("batt4data13").innerHTML = (Number(obj.batt4data13)).toFixed(1);
	document.getElementById("batt5data13").innerHTML = (Number(obj.batt5data13)).toFixed(1);
	document.getElementById("batt6data13").innerHTML = (Number(obj.batt6data13)).toFixed(1);
	document.getElementById("batt7data13").innerHTML = (Number(obj.batt7data13)).toFixed(1);
	document.getElementById("batt8data13").innerHTML = (Number(obj.batt8data13)).toFixed(1);
	document.getElementById("batt1data15").innerHTML = Number(obj.batt1data15);		//Get SOCs
	document.getElementById("batt2data15").innerHTML = Number(obj.batt2data15);
	document.getElementById("batt3data15").innerHTML = Number(obj.batt3data15);
	document.getElementById("batt4data15").innerHTML = Number(obj.batt4data15);
	document.getElementById("batt5data15").innerHTML = Number(obj.batt5data15);
	document.getElementById("batt6data15").innerHTML = Number(obj.batt6data15);
	document.getElementById("batt7data15").innerHTML = Number(obj.batt7data15);
	document.getElementById("batt8data15").innerHTML = Number(obj.batt8data15);
	...
	document.getElementById("batt1hightemp").innerHTML = (Number(batt1hightemp)).toFixed(1);
	document.getElementById("batt2hightemp").innerHTML = (Number(batt2hightemp)).toFixed(1);
	document.getElementById("batt3hightemp").innerHTML = (Number(batt3hightemp)).toFixed(1);
	document.getElementById("batt4hightemp").innerHTML = (Number(batt4hightemp)).toFixed(1);
	document.getElementById("batt5hightemp").innerHTML = (Number(batt5hightemp)).toFixed(1);
	document.getElementById("batt6hightemp").innerHTML = (Number(batt6hightemp)).toFixed(1);
	document.getElementById("batt7hightemp").innerHTML = (Number(batt7hightemp)).toFixed(1);
	document.getElementById("batt8hightemp").innerHTML = (Number(batt8hightemp)).toFixed(1);
